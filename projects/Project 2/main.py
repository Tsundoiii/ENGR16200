...
particle = 1e-12 * 1e-9 # microg / particle PM10
concentration = 1 / particle / 16.28 # particle / m^3
area = 8
power = 1.4 * 1000 # Wen
...
flow = area / time
power_consumption = power * 60 * 60 * 24
    
print(f"Time: {time:.5f} s, Distance: {distance:.5f} m, Velocity: {velocity:.5f} m/s, Flow: {flow:.5f} particle / sec, Power consumption: {power_consumption} J / day")    
